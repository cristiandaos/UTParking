...
<head>
	...
	<title>Ingresos totales - UTParking</title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Total de ingresos</div>
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <p class="lead text-center"><?php echo "Cargo total por estacionamiento cobrado hasta la fecha - " . date("Y/m/d") . "<br>"; ?></p>
							<div class="progress">
        ...
        <div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Ingresos de hoy</div>
						<div class="panel-body">
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <p class="lead text-center">Recaudación total de cargos de estacionamiento de hoy</p>
							<div class="progress">
        ...
        <div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Ingresos de ayer</div>
						<div class="panel-body">
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <p class="lead text-center">Cobro total de cargos de estacionamiento de ayer</p>
							<div class="progress">
								<div data-percentage="0%" style="width: 20%;" class="progress-bar progress-bar-teal" role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
							</div>
