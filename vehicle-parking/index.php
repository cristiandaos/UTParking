					...
					<?php if($msg)
						...
						<fieldset>
							...
							<div class="checkbox">
								...
								<a href="forgot-password.php" style="text-decoration:none;">¿Has olvidado tu contraseña?</a>
							</div>
							<button class="btn btn-success" type="submit" name="login">Iniciar sesión</button></fieldset>
					</form>
				</div>
			</div>
		</div><!-- /.col-->
