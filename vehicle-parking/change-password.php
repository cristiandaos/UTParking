...
<head>
	...
	<title>Cambiar contraseña - UTParking</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Administrador de contraseña</li>
			</ol>
		</div><!--/.row-->
						...
						$msg</div>" ?> 
							...
							<form method="POST">
								...
								<div class="form-group">
                                    ...
                                    <center>
                                    <button type="submit" class="btn btn-info" name="change-password">Cambiar contraseña</button>
