...
<head>
	...
	<title>Actualizar categoría - UTParking</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Administrar categoría de vehículo</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="panel panel-default">
					<div class="panel-heading">Actualizar categoría de vehículo</div>
					<div class="panel-body">
						...
						<em class='fa fa-lg fa-close'>
                            ...
                            <?php }?>
									...
									<button type="submit" class="btn btn-success" name="update-category">Guardar cambios</button>
								</div> <!--  col-md-12 ends -->
							</form>
						</div> 
					</div>
