...
<head>
	...
	<title>Reportes - UTParking</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Visualizar reportes</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Reportes de parqueo</div>
                        ...
                        <form method="POST" enctype="multipart/form-data" name="datereports" action="generate-reports.php">
                            ...
                            <div class="panel-body">
                                ...
                                <em class='fa fa-lg fa-close'>
                                    ...
                                    <center><button type="submit" class="btn btn-primary" name="submit">Generar reporte</button></center>
