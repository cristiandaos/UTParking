...
<head>
	...
	<title>Sistema de parqueo de vehículos</title>
	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading text-center"><b>Recuperar contraseña</b></div>
				<div class="panel-body">
					...
					<?php if($msg)
						...
						<fieldset>
							...
							<button class="btn btn-primary" type="submit" name="reset">Siguiente</button>
                            <a href="index.php"><button class="btn btn-info" type="button">Atrás</button></a>
                            </fieldset>
					</form>
				</div>
			</div>
